  ...
  return (
    <div className="min-h-screen bg-page text-tx-primary font-sans pb-10">
      ...
      <header className="sticky top-0 z-40 h-14 flex items-center gap-3 px-4 md:px-6 bg-card/90 backdrop-blur-md border-b border-border-l">
        ...
        <span className="font-semibold text-sm text-tx-primary flex-1">Event Checkout</span>
        {lockExpiresAt && (
        ...
        <div className="space-y-4">
          ...
          <div className="p-5 rounded-xl bg-card border border-border-l">
            <div className="flex items-start gap-4">
              {/* Poster */}
              <div className="flex-shrink-0 w-16 h-16 rounded-xl overflow-hidden bg-section border border-border-l">
                {ctx?.posterUrl
              ...
              <div className="flex-1 min-w-0">
                ...
                {ctx?.venueName && (
                  <p className="text-sm text-tx-secondary font-sans mt-1">
            ...
            {/* Tier + quantity */}
            {ctx && (
              <div className="mt-4 flex items-center gap-3 pt-4 border-t border-border-l">
                <span className="px-3 py-1 rounded-full bg-brand/15 text-brand text-xs font-semibold font-sans">
                  {ctx.tierName}
                </span>
                <span className="text-sm text-tx-secondary font-sans">
            ...
            <div className="flex items-center justify-between py-2.5 mt-3 border-t border-border-l">
              <span className="text-sm text-tx-muted font-sans">Ticket Amount</span>
              <span className="font-semibold text-sm text-tx-primary font-sans">
