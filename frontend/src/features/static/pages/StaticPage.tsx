...
const PAGES: Record<string, PageContent> = {
  about: {
    ...
    emoji: '🎬',
    body: (
      <div className="prose-sm space-y-4 text-tx-secondary font-sans leading-relaxed">
        ...
        <p>We support booking for <strong className="text-tx-primary">movies, live events, concerts, plays, sports, activities, and TATA IPL 2026</strong> across 25 Indian cities.</p>
        ...
        <h3 className="text-tx-primary font-semibold mt-6">Contact Us</h3>
        <p>Email: <a href="mailto:support@bookkaroo.com" className="text-brand">support@bookkaroo.com</a></p>
        <p>Address: 701, Demo Tower, SG Highway, Bodakdev, Ahmedabad, Gujarat 380054</p>
        <p className="text-xs text-tx-muted mt-6">© 2026 BookKaroo Pvt Ltd · GSTIN: 24XXXXX0000X1Z5 (demo placeholder)</p>
      </div>
    ),
  },
  careers: {
    ...
    emoji: '🚀',
    body: (
      <div className="space-y-4 text-tx-secondary font-sans text-sm leading-relaxed">
        ...
        <p>Send your resume to <a href="mailto:careers@bookkaroo.com" className="text-brand underline">careers@bookkaroo.com</a></p>
        <div className="p-4 rounded-xl bg-section border border-border-l mt-6">
          <p className="font-semibold text-tx-primary mb-2">Open Positions</p>
          <p className="text-tx-muted text-sm">No open positions at the moment. Check back soon!</p>
        </div>
      </div>
    ),
  },
  'list-your-show': {
    ...
    body: (
      <div className="space-y-4 text-tx-secondary font-sans text-sm leading-relaxed">
        ...
        <p>Email us at <a href="mailto:partners@bookkaroo.com" className="text-brand underline">partners@bookkaroo.com</a> to get started.</p>
  ...
  blog: {
    ...
    emoji: '📝',
    body: (
      <div className="space-y-4 text-tx-secondary font-sans text-sm">
        <p>Stories, guides, and behind-the-scenes from the world of Indian entertainment.</p>
        <p className="text-tx-muted">Blog posts coming soon!</p>
      </div>
    ),
  },
  'terms': {
    ...
    body: (
      <div className="space-y-4 text-tx-secondary font-sans text-sm leading-relaxed">
        <p className="text-tx-muted text-xs">Last updated: 9 May 2026</p>
        <h3 className="font-semibold text-tx-primary">1. Booking & Payment</h3>
        ...
        <h3 className="font-semibold text-tx-primary">2. Cancellation Policy</h3>
        ...
        <h3 className="font-semibold text-tx-primary">3. Use of Service</h3>
        <p>BookKaroo is for personal use only. Reselling tickets is prohibited and will result in account termination.</p>
        <h3 className="font-semibold text-tx-primary">4. GST</h3>
        ...
        <p className="text-xs text-tx-muted mt-6">For queries, contact support@bookkaroo.com</p>
      </div>
    ),
  },
  'privacy': {
    ...
    body: (
      <div className="space-y-4 text-tx-secondary font-sans text-sm leading-relaxed">
        ...
        <h3 className="font-semibold text-tx-primary">Your Rights</h3>
  ...
  'faq': {
    title: 'FAQ',
    emoji: '❓',
    body: <p className="text-tx-secondary font-sans text-sm">Redirecting to Help Centre…</p>,
  },
  'sitemap': {
    title: 'Sitemap',
    emoji: '🗺️',
    body: (
      <div className="space-y-2 text-sm font-sans">
        {[
          ...
          <div key={href}><a href={href} className="text-brand hover:underline">{label}</a></div>
        ))}
      </div>
    ),
  },
  ...
  if (!page) return (
    <PublicLayout>
      <div className="max-w-[760px] mx-auto px-6 py-16 text-center">
        ...
        <p className="text-tx-muted font-sans">Page not found.</p>
      </div>
    </PublicLayout>
  );
