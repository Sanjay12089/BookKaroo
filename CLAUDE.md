...
- **Flow:** branch from `develop` → PR → merge to `develop` → release merges `develop` → `main`
...
- `/SKILLS.md` — coding standards Claude should follow
...
2. Pull latest `develop`, branch off
