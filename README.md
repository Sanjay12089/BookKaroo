...
[![Database](https://img.shields.io/badge/Database-PostgreSQL_%2F_Supabase-336791)](bookkaroo-db)
...
├── bookkaroo-db/         # SQL migrations + seed scripts
...
| [ISSUES.md](docs/ISSUES.md) | Known bugs |

---

## 🔐 Local Dev Accounts
Seed scripts in [`bookkaroo-db/seeds/`](bookkaroo-db/seeds/) create local test users after you run the migrations against your own Supabase project. No credentials are published in this repo or its history — set up your own local accounts via the seed scripts, or sign up through the app.
